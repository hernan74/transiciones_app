...
class Pagina1 extends StatelessWidget {
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.push(context, _fadeTransition(Pagina2()));
                },
                child: Text('Fade Transition')),
            ElevatedButton(
                onPressed: () {
                  Navigator.push(context, _trancicionConvinada(Pagina2()));
                },
                child: Text('Trancicion Convinada')),
          ],
        ),
      ),
    );
  ...
  Route _fadeTransition(Widget child) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => child,
  ...
  Route _trancicionConvinada(Widget child) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => child,
      transitionDuration: Duration(seconds: 1),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
